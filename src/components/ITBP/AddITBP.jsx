...
const saveITBP = async (e) => {
e.preventDefault();
if (!validate()) {
showError("Failed to add ITBP because of missing fields");
return;
}
      ...
      onClick: async () => {
        ...
        try {
          ...
          const msg =
            ...
            "Failed to add ITBP, please try again!";
          showError(msg);
          console.error("Add ITBP error:", msg);
        } finally {
          setLoading(false);
        }
      },
...
return ( <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-50 p-4 font-sans backdrop-blur-sm"> <div className="bg-white rounded-xl w-[500px] max-w-full shadow-2xl overflow-hidden transition-all duration-300 transform scale-100">
{/* Header */}
<div
...
FORM ADD NEW ITBP USER </h3> <button
         onClick={onClose}
         className="p-1 rounded-full hover:bg-white/20 transition-colors text-white"
         aria-label="Close form"
       > <FaTimes className="w-5 h-5" /> </button> </div>


    {/* Body */}
    <form onSubmit={saveITBP} className="p-6">
